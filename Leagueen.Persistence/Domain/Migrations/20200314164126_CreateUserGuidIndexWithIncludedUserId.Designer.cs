...
namespace Leagueen.Persistence.Domain.Migrations
{
    ...
    [Migration("20200314164126_CreateUserGuidIndexWithIncludedUserId")]
    partial class CreateUserGuidIndexWithIncludedUserId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Leagueen.Domain.Entities.Friendship", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasAnnotation("SqlServer:Include", new[] { "FriendId", "IsActive" });

                    b.ToTable("Friendships");
                });

            modelBuilder.Entity("Leagueen.Domain.Entities.FriendshipRequest", b =>
                {
                    ...
                    b.Property<Guid>("FriendshipRequestGuid");
                    ...
                    b.HasIndex("FriendshipRequestGuid")
                        .IsUnique()
            ...
            modelBuilder.Entity("Leagueen.Domain.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
